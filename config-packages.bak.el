...
;; (use-package magit
;;   :requires (dash git-commit magit-section transient with-editor)
;;   :commands magit)
...
(use-package org-roam-bibtex
  :requires (org-roam bibtex-completion org-ref citeproc)
  :after org-roam
...
(use-package magit-todos
  :requires (async dash f hl-todo magit pcre2el s transient))
